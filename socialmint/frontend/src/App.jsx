...
function LoginScreen({ onLogin }) {
  ...
  async function handleClerkUser(clerkUser) {
    try {
      ...
      const res  = await fetch(`${API}/api/auth/login`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ userId, name, provider, email }) });
      const data = await res.json();
...
function Dashboard({ user, onLogout }) {
  ...
  useEffect(() => {
    async function fetchAnalyses() {
      try {
        const res = await fetch(`${API}/api/analyses`, { headers: { "Authorization": `Bearer ${token()}` } });
        const data = await res.json();
  ...
  const DEMO_PROMPTS = [
    ...
    { id:2, category:"🇳🇬 Nigeria & Africa", platform:"TikTok", goals:["content","marketing"], color:"#010101", colorBg:"#F0F0F0", title:"Lagos street food vendor", icon:"🍔", niche:"I sell suya, puff puff and jollof rice from my food cart in Lagos Island. I just started a TikTok account showing how I cook and the crowd reactions. I have 1,200 followers after just 2 weeks and my videos keep going viral." },
    { id:3, category:"🇳🇬 Nigeria & Africa", platform:"Instagram", goals:["products","marketing"], color:"#E91E8C", colorBg:"#FDE8F4", title:"Ankara fashion boutique", icon:"👗", niche:"I own a small Ankara and Aso-oke fashion boutique in Abuja. I post outfit photos and styling videos on Instagram. My customers are mainly working-class Nigerian women aged 28–45. I have 5,500 followers and want to sell more online." },
    { id:4, category:"🇳🇬 Nigeria & Africa", platform:"TikTok", goals:["content","products"], color:"#010101", colorBg:"#F0F0F0", title:"Nigerian comedy skit creator", icon:"😂", niche:"I make Nigerian comedy skits on TikTok poking fun at office life, Lagos traffic, and Nigerian parents. I have 45,000 followers and my videos regularly hit 200k+ views. I want to know how to make real money from this." },
    { id:5, category:"💼 Business Owners", platform:"Facebook", goals:["marketing","products"], color:"#1877F2", colorBg:"#EBF3FE", title:"Hair salon owner in Abuja", icon:"💇", niche:"I run a hair and beauty salon in Abuja called GlowUp Studio. I post before/after photos on Facebook and have 3,200 page likes. My clients are professional women. I want more bookings and to sell hair products online." },
    { id:6, category:"💼 Business Owners", platform:"LinkedIn", goals:["marketing","content"], color:"#0A66C2", colorBg:"#E8F3FB", title:"Freelance graphic designer", icon:"🎨", niche:"I am a freelance graphic designer and brand identity consultant based in Lagos. I have 2,800 LinkedIn connections and post design tips and case studies. My target clients are Nigerian startups and SMEs needing brand identity work." },
    { id:7, category:"💼 Business Owners", platform:"Instagram", goals:["products","content"], color:"#E91E8C", colorBg:"#FDE8F4", title:"Handmade skincare brand", icon:"🧴", niche:"I make and sell natural African black soap, shea butter and skincare products from home in Port Harcourt. I have an Instagram page with 6,000 followers. Most of my customers are Nigerian women who want chemical-free skincare." },
    { id:8, category:"💼 Business Owners", platform:"X / Twitter", goals:["marketing","content"], color:"#000000", colorBg:"#F0F0F0", title:"Dropshipping business", icon:"📦", niche:"I run a dropshipping business selling electronics accessories, phone cases and smart gadgets targeted at Nigerian youth. I use X/Twitter to promote and have 4,100 followers. I want more traffic to my website and more sales." },
    { id:9, category:"🎨 Creators", platform:"YouTube", goals:["products","content"], color:"#FF0000", colorBg:"#FFEBEB", title:"Nigerian food vlogger", icon:"🍳", niche:"I run a YouTube channel teaching people how to cook authentic Nigerian dishes like egusi soup, jollof rice and pepper soup. I have 22,000 subscribers. My audience is Nigerians in diaspora and food lovers globally who want to cook African food." },
    { id:10, category:"🎨 Creators", platform:"TikTok", goals:["content","marketing"], color:"#010101", colorBg:"#F0F0F0", title:"Gen Z personal finance creator", icon:"💰", niche:"I make TikTok videos about personal finance, saving money and investing for Nigerian Gen Z aged 18–26. I have 31,000 followers and my content about saving on a low income gets the most views. I want to monetize my knowledge." },
    { id:11, category:"🎨 Creators", platform:"YouTube", goals:["products","marketing"], color:"#FF0000", colorBg:"#FFEBEB", title:"African travel vlogger", icon:"✈️", niche:"I vlog about travelling across Africa on a budget — I have visited 18 African countries and document everything on YouTube. I have 14,000 subscribers and my audience is young African professionals who want to explore the continent." },
